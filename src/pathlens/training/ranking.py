...
def sample_ranked_negatives(
    ...
    *,
    ...
    for row, (drug, _protein) in enumerate(positives):
        drug_index = int(drug)
...
def _require_torch() -> Any:
    try:
        ...
        raise RuntimeError(
            "sampled softmax requires PyTorch. Kaggle images already have it."
        ) from error
    return torch
